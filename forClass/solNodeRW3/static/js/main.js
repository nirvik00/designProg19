function setup(){
    ...
    var mtlLoader=new THREE.MTLLoader().load("/static/assets/model/rhObj.mtl", function(materials){
        var objLoader=new THREE.OBJLoader().load("/static/assets/model/rhObj.obj", function(object){
            object.scale.set(0.5,0.5,0.5);
            object.position.set(150,150,50);
            scene.add(object);
        });
    });
